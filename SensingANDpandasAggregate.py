...
import sys
#sys.path.append([ '/usr/lib/python35.zip', '/usr/lib/python3.5', '/usr/lib/python3.5/plat-arm-linux-gnueabihf', '/usr/lib/python3.5/lib-dynload', '/home/pi/.local/lib/python3.5/site-packages', '/usr/local/lib/python3.5/dist-packages', '/usr/local/lib/python3.5/dist-packages/spidev-3.3-py3.5-linux-armv7l.egg', '/usr/lib/python3/dist-packages', '/usr/lib/python3.5/dist-packages'])
...
Sensor_outputpaths=[
    "./output_csv/IRSensor1_ourput.csv",
    "./output_csv/IRSensor2_ourput.csv",
    "./output_csv/IRSensor3_ourput.csv",
    "./output_csv/Sensor4_ourput.csv"]
    ...
    while True:
        ...
        while True: #1day loop
            ...
            while True: #1hour loop
                ...
                if (datetime.now()-StartTimeH).total_seconds()>300:
                    break
...
if __name__ == "__main__":
    with open("debug.txt", "a") as f:
        f.write(datetime.now().strftime("%Y_%m_%d")+":"+str(sys.version)+"\n")
    main()
